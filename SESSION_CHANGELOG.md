...
- для последующих доработок лучше опираться одновременно на этот файл и на [README_AI.md](README_AI.md).
...
- [frontend/src/hooks/useTypewriter.js](frontend/src/hooks/useTypewriter.js)
...
Затронутые файлы:
- [frontend/src/constants/roles.js](frontend/src/constants/roles.js)
- [frontend/src/constants/specialties.js](frontend/src/constants/specialties.js)
...
- [frontend/src/components/Mascot.jsx](frontend/src/components/Mascot.jsx)
...
- [00_check_ollama.bat](00_check_ollama.bat)
- [01_prepare_ollama_models.bat](01_prepare_ollama_models.bat)
- [02_refresh_project_models.bat](02_refresh_project_models.bat)
- [03_start_round_table.bat](03_start_round_table.bat)
- [start_core.bat](start_core.bat)
- [start.bat](start.bat)
- [refresh_project_models.ps1](refresh_project_models.ps1)
...
- SQLite на пути [backend/data/circletable.db](backend/data/circletable.db)
...
- файл: [backend/chronomancer.py](backend/chronomancer.py)
...
Отдельно проверено:
- dry-run для [shutdown_round_table.ps1](shutdown_round_table.ps1)
...
- создан оформленный [README.md](README.md) в стиле самой программы;
- добавлен пиксельный баннер [assets/github-header.svg](assets/github-header.svg);
- локализованы [start.bat](start.bat) и [start_core.bat](start_core.bat);
- [README_AI.md](README_AI.md) обновлён с учётом новой стилизации GitHub и сценариев запуска.
...
- [frontend/public/favicon.png](frontend/public/favicon.png) — PNG-иконка приложения;
- [frontend/public/social-preview.svg](frontend/public/social-preview.svg) — social preview карточка приложения;
- [frontend/public/social-preview.png](frontend/public/social-preview.png) — PNG social preview карточка приложения;
- [assets/github-header.png](assets/github-header.png) — PNG-версия шапки репозитория;
- [assets/repo-social-preview.svg](assets/repo-social-preview.svg) — social preview для репозитория;
- [assets/repo-social-preview.png](assets/repo-social-preview.png) — PNG social preview для репозитория;
- [RELEASE_README.md](RELEASE_README.md) — отдельный релизный README;
- [RELEASE_v0.1.0.md](RELEASE_v0.1.0.md) — текст первого релиза;
- [CHANGELOG.md](CHANGELOG.md) — версионируемый changelog;
- [frontend/index.html](frontend/index.html) обновлён мета-тегами `description`, `theme-color`, `og:*`, `twitter:*` и ссылкой на новый favicon.
...
- в [frontend/src/components/RoomsDrawer.jsx](frontend/src/components/RoomsDrawer.jsx) появилась кнопка `Диалоги`;
...
- backend получил REST-маршруты `/api/rooms/{roomId}/sessions`, `/api/sessions/{sessionId}`, `/api/sessions/{sessionId}/open`, `/api/sessions/{sessionId}/continue`, `/api/sessions/{sessionId}/export.md` и связанные операции в [backend/storage.py](backend/storage.py).

Дополнительно добавлен кастинг-помощник:
- новый backend-сервис [backend/casting.py](backend/casting.py);
- новый UI [frontend/src/components/CastingAssistantModal.jsx](frontend/src/components/CastingAssistantModal.jsx);
